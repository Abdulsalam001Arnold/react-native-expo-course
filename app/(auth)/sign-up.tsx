...
import { Text, TextInput, Pressable, View, TouchableWithoutFeedback, Keyboard, ActivityIndicator, Alert, TouchableOpacity } from 'react-native'
...
export default function SignUpScreen() {
  ...
  const onSSOPress = async(strategy: "oauth_google" | "oauth_github" | "oauth_microsoft") => {
      try {
        setLoading(true)
  ...
  return (
      ...
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20}}>
        ...
        <View>
          ...
          style={{
            borderWidth: 1, padding: 8, marginVertical: 10, width: 250, borderRadius: 10
          }}
          />
